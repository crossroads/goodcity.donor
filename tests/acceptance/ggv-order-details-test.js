...
//     assert.equal($(".list-items li").text().indexOf("example") > 0, true);
//     assert.equal($(".delivery-to").text().trim().indexOf(t("ggv_order.crossroads_address1")) >= 0, true);
//   });
// });
...
//   andThen(function() {
//     assert.equal($(".list-items li").text().indexOf("example") > 0, true);
//     assert.equal($(".offer-status .msg").text().trim().indexOf("您到達時，我們的職員會核對並確認下列資料")  >= 0, false);
